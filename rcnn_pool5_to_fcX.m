...
if layer > 5
  for i = 6:layer
    ...
    layerid = ['fc', num2str(i)];
    feat = max(0, bsxfun(@plus, feat*rcnn_model.cnn.model.layers(layerid).params(1).get_data(), ...
                      rcnn_model.cnn.model.layers(layerid).params(2).get_data()') );
  end
end
